...
\begin{frame}
		...
		\end{figure}
	\end{frame}
		\section{Gesundheitsstatus}
	\begin{frame}
		\frametitle{Gesundheitsstatus nach Farm}
		\begin{figure}[h]
			\centering
			\includegraphics[scale=0.35]{Mosaikplots.png}
			\vspace{-0.8cm}
			\caption{Mosaikplot zum Gesundheitsstatus in Abhängigkeit der Farm}
		\end{figure}
	\end{frame}
	\begin{frame}
		\frametitle{Gesundheitsstatus nach Glukosewerte}
		\begin{figure}[h]
			\centering
			\includegraphics[scale=0.33]{Bedingtes Dichtediagramm.png}
			\vspace{-0.6cm}
			\caption{Bedingtes Dichtediagramm: Abhängigkeit Gesundheitsstatus und Glukosewert}
		\end{figure}
	\end{frame}
